...
// console.log(food);
// food.splice(2, 0, 'Sweet potato pie');//asks for an insertions point, how many things to remove, the item(s) to add
// console.log(food);
// food.pop();//removes the last element of the arrays
// console.log(food);
